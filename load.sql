...
INTO TABLE ΔΙΟΙΚΗΤΙΚΟ_ΠΡΟΣΩΠΙΚΟ
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
INTO TABLE ΣΤΟΙΧΕΙΑ_ΟΙΚΕΙΩΝ_ΑΤΟΜΩΝ
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
INTO TABLE ΑΣΦΑΛΙΣΤΙΚΟΣ_ΦΟΡΕΑΣ
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
INTO TABLE ΤΜΗΜΑ_ΕΠΕΙΓΟΝΤΩΝ_ΠΕΡΙΣΤΑΤΙΚΩΝ
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
INTO TABLE ΙΑΤΡΙΚΕΣ_ΠΡΑΞΕΙΣ_ΑΣΘΕΝΗ
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
INTO TABLE ΕΞΕΤΑΣΕΙΣ_ΑΠΟΤΕΛΕΣΜΑΤΑ
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
INTO TABLE ΑΞΙΟΛΟΓΗΣΗ_ΝΟΣΗΛΕΙΑΣ
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
INTO TABLE ΔΙΑΓΝΩΣΕΙΣ_ΝΟΣΗΛΕΙΑΣ
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
